...
#define PPC64_SLB_ESID_VALID (1ULL << 27)
#define PPC64_SLB_VSID_SHIFT 12
#define PPC64_SLB_VSID_KS (1ULL << 11)
#define PPC64_SLB_VSID_KP (1ULL << 10)
#define PPC64_SLB_VSID_N (1ULL << 9)
#define PPC64_SLB_VSID_L (1ULL << 8)
#define PPC64_SLB_VSID_C (1ULL << 7)
#define PPC64_SLB_VSID_SSIZE_SHIFT 62
#define PPC64_SLB_SSIZE_256M 0
#define PPC64_SLB_VSID_KERNEL PPC64_SLB_VSID_KP
#define PPC64_SLB_VSID_USER (PPC64_SLB_VSID_KP | PPC64_SLB_VSID_KS | PPC64_SLB_VSID_C)
